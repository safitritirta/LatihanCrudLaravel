                ...
                <div class="card border-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" value="{{ $jurusan->nama_mata_pelajaran }}" class="form-control" readonly value="{{ $jurusan->kode_mata_pelajaran}}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="content" class="form-control" readonly value="{{ $jurusan->jurusan }}">
                                </input>
                        </div>
